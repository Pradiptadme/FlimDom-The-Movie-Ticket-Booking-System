...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_array($result)) {
    ...
    <tr>
              ...
              <td><button data-toggle="modal" type="button" data-target="#delete_movie_modal<?php echo $id;?>" class="btn btn-danger btn-sm"><?php echo  "<a style='text-decoration: none; color:white;' href='deletemovie.php?id=" . $row['id'] . "' >Delete Movie</a>"; ?></button></td></td>
            </tr>
